...
| Playbooks | `ansible-playbook playbook.yml --tags "tag1,tag2"` | Run only the tasks tagged with tag1 and tag# |
| Playbooks | `ansible-playbook playbook.yml --skip-tags "tag3"` | Skip tasks tagged with tag# |
...
| Playbooks | `ansible-playbook playbook.yml --forks=5` | Set the number of parallel processes to # |
